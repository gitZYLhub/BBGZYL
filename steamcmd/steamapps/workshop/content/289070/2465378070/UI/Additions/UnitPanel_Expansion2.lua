...
function ReadCustomUnitStats( pUnit:table, kSubjectData:table )	
	...
	if (GameInfo.Units[kSubjectData.UnitType].UnitType == "UNIT_ROCK_BAND") 
	or (GameInfo.Units[kSubjectData.UnitType].UnitType == "UNIT_ORAL_SCHOLAR") 
	or (GameInfo.Units[kSubjectData.UnitType].UnitType == "UNIT_TRAVEL_THEATRE") 
	or (GameInfo.Units[kSubjectData.UnitType].UnitType == "UNIT_MALI_GRIOTS") then 
