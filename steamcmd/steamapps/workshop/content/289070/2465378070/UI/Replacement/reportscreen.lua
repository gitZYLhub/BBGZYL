print("HD Override Loading ReportScreen.lua from Better Report Screen version "..GlobalParameters.BRS_VERSION_MAJOR.."."..GlobalParameters.BRS_VERSION_MINOR);
-- ===========================================================================
--	ReportScreen
--	All the data
...
function NewCollapsibleGroupInstance( isCollapsed:boolean )
	...
	-- 删除ToolTip
	instance.RowHeaderButton:SetToolTipString(nil);
...
-- ===========================================================================
include("BRSPage_ResourceClassifications");
...
function LateInitialize()
	...
	-- 资源分类
	AddTabSection( "LOC_HUD_REPORTS_TAB_RESOURCE_CLASSIFICATIONS",		ViewResourceClassificationsPage );
...
function Initialize()
	...
	InitializePolicy();
	InitializeMinor();
	InitializeResourceClassifications();
	...
	-- 资源分类
	LuaEvents.ReportsList_OpenResourceClassifications.Add( function() Open(10); end );
